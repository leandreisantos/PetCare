...
public class CustomerCreateProfile extends AppCompatActivity {
    ...
    AllCustomerUserMember ownerMember;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ownerMember = new AllCustomerUserMember();
        member = new AllUserMember();

        documentReference = db.collection("user").document(currentUserId);
        storageReference = FirebaseStorage.getInstance().getReference("Profile images");
        databaseReference = database.getReference("All users");
        databaseReference2 = database.getReference("All Customer users");
    ...
    private void uploadProfile() {
        ...
        if(!TextUtils.isEmpty(name)&&!TextUtils.isEmpty(mobile)&&!TextUtils.isEmpty(landline)
            ...
            Task<Uri> urlTask = uploadTask.continueWithTask((Task<UploadTask.TaskSnapshot> task) -> {
                ...
                ownerMember.setStatus("Customer");
                ...
                documentReference.set(profile)
                        .addOnSuccessListener(aVoid -> {
                            Toast.makeText(CustomerCreateProfile.this, "Profile Created", Toast.LENGTH_SHORT).show();

                            Handler handler = new Handler();
                            handler.postDelayed(() -> {
                                Intent intent = new Intent(CustomerCreateProfile.this,MainActivity.class);
            ...
            Toast.makeText(CustomerCreateProfile.this, "Fill up All Requirements!", Toast.LENGTH_SHORT).show();
        }
